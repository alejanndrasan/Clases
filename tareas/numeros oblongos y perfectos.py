#Variables:
estructura_base = {'objeto_1': ([126, 306, 832, 264], [679, 592, 280, 562, 25], [918, 984, 251], [490, 13, 822], [454, 495, 633, 357, 186], [949], [926, 940, 215, 725], [21, 18, 467, 660, 370], [915], [132, 437, 467], [], [530, 304, 345, 398, 466], [256, 899], [], [925], [45], [824, 245, 447, 981, 84], [468, 364], [158, 15], [704, 367, 812, 46], [], [], [601, 717, 423, 212]),
...
for objeto, contenido in estructura_base.items():
    ...
    print(f"El {objeto} tiene {oblongos} numeros oblongos, \n {perfectos} numeros perfectos, y su promedio es de {promedio}" )
